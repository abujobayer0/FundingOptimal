...
const FAQsPage = () => {
  return (
    <div className="mt-20">
      <div className="max-w-7xl mx-auto mt-[120px] px-4">
        <div className="space-y-0 md:space-y-4 text-center">
      ...
      >
        ...
        <div className="flex flex-col -mt-8 items-center justify-center">
          ...
          <div className="space-y-0 md:space-y-4 mt-4 text-center">
            <h1 className="text-3xl md:text-5xl lg:text-[70px] font-bold">
              Join FundingOptimal
            </h1>
            ...
            <p className="text-[16px]">
              Traders can take their trading to the next level and embark on
              their journey to become funded prop traders.
            </p>
            <button
